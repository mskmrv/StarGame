...
public class EnemyGenerator {
    ...
    private final TextureRegion[] enemmySmallRegion;
    private final TextureRegion[] enemmyMediumRegion;
    private final TextureRegion[] enemmyBigRegion;
    ...
    public EnemyGenerator(TextureAtlas atlas, EnemyPool enemyPool, Rect worldBounds) {
        ...
        this.enemmySmallRegion = Regions.split(enemy0, 1, 2, 2);

        TextureRegion enemy1 = atlas.findRegion("enemy1");
        this.enemmyMediumRegion = Regions.split(enemy1, 1, 2, 2);

        TextureRegion enemy2 = atlas.findRegion("enemy2");
        this.enemmyBigRegion = Regions.split(enemy2, 1, 2, 2);
